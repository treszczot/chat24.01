$(function(){
  ...
  $('#login').click(function(){
    name = $('#name').val(); //pobieram imie w sumie nie potrzebne
    peer_id = $('#peer_id').val();//samo geste id pieraaaa
    if(peer_id){
//jezeli wkleimi id peera i swoja nazwe to nawiazuje polaczeni
      conn = peer.connect(peer_id, {metadata: {
        'username': name //po polaczeniu przesyla swoje imie
      }});
  ...
  $('#call').click(function(){
    ...
    call.on('stream', function(stream){
      ...
      //jak dostanie stream to przesyła do diva peer-camera
    });
  });
